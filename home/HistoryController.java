...
public class HistoryController implements Initializable
{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        int total_Schedule=Data.historyList.size();
        Node[] nodes = new Node[total_Schedule];
        //Node[] nodes = new Node[10];
        for (int i = 0; i < nodes.length; i++) {
            try {

                String strName=Data.historyList.get(i).title;
                String strRemindTime=Data.historyList.get(i).end.toString();
                String strImportance=Data.historyList.get(i).importance.name();
                String strStatus=Data.historyList.get(i).status.name();
                String strSupplement=Data.historyList.get(i).text;

                Data.curIndex = Data.futureList.size() + i;
